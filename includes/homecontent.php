<div id='main'>
      <div class="text-wrap">
        ...
        <ul id="items">
          ...
          <h2><span>Summer 2013</span>: I spent this past summer working for BNY Mellon as a software development intern. I worked on the web application team where we spent the summer preparing to upgrade the application to the latest version of the software. I created components such as a datagrids with filtering, sorting and other features for the new portal using the Dojo framework. I also gained exposure to server side Java (JSP) and noSQL databases through development with MongoDB. Check me out in the video below!</h2>
					<h2><span>Video Coming Soon!</span></h2>
					<br>
					<h2><span>Summer 2010</span>: I completed my first internship at Stanford's Center for Interdisciplinary Brain Sciences Research (CIBSR) as a technical intern. This was where I was introduced to how software development and usable interfaces really makes an impact on efficiency in the workplace. I worked on a software called Brain Image Java (BIJ) with my mentor, and we spent the summer improving the UI components of the software. Simple changes such as the location of a scrollbar or the default settings for the MRI display helped make the software less painful to use for the lab researchers.   </h2>
				</div>
        <br>
        ...
        <br>
          ...
          <h2><span>Ukulele &amp; Guitar</span>: The challenge of teaching yourself a skill from scratch is something I find exciting and addicting, which is why I started getting into these instruments. I started playing my Freshman year in college and before you know it, I was playing songs by famous Ukulele artists such as <a href='http://www.youtube.com/watch?v=puSkP3uym5k' target='_blank'>Jake Shimabukuro</a> and <a href='http://www.youtube.com/watch?v=naHHHwoMDaU'>Troy Fernandez</a>. The following year I bought myself an Alvarez acoustic guitar and I was once again hooked. Check out <a href='http://www.youtube.com/watch?v=AhR04kmcSXU' target='_blank'>Tommy Emmanuel</a>, he's one of my favorite acoustic soloists.</h2>
