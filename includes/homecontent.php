<div id='main'>
      <div class="text-wrap">
        ...
        <br>
        	...
        	<h2>I grew up on the San Francisco Peninsula and I currently live in Pittsburgh, PA as I attend school. My major is in Information Systems and I am working towards a minor in Human Computer Interaction, which I am turning into a double major. Through my experiences, I have discovered that the efficient display of information and the development of user-friendly software is essential to a successful company, no matter what industry it is in. This is my niche and I plan to be able to utilze my skills as a programmer (with an eye for design) to help build better interfaces.</h2>
				</div> 
        <br>
				<div class='text-wrap inside-text text-body'>
